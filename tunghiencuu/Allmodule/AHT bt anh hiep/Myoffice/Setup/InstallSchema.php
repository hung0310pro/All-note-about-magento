...
/*
 table  : eav_entity_type(http://prntscr.com/ozygg7),eav_attribute(http://prntscr.com/ozygoo).
 create :aht_myoffice_employee_entity, aht_myoffice_department,
...
class InstallSchema implements InstallSchemaInterface
{
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        /**
         * Create table 'aht_myoffice_department'
         */
        $table = $setup->getConnection()->newTable(
            $setup->getTable('aht_myoffice_department')
        )->addColumn(
            'entity_id',
            ...
            'AHT Myoffice Department Table'
        );
        $setup->getConnection()->createTable($table);


        /* create attribute table aht_myoffice_employee_entity */
        ...
        $table = $setup->getConnection()
            ...
            ->setComment('AHT Myoffice Employee Table');
        $setup->getConnection()->createTable($table);

        /* create table aht_myoffice_employee_entity_int */
        $table = $setup->getConnection()
	        ...
	        /* create UNIQUE KEY http://prntscr.com/ozyd2r */
            ->addIndex(
                $setup->getIdxName(
	        ...
	        /* add  ForeignKey attribute_id is ForeignKey of attribute_id of table eav_attribute*/
            ->addForeignKey(
            ...
            ->setComment('AHT Myoffice Employee Integer Attribute Backend Table');
        $setup->getConnection()->createTable($table);
        $table = $setup->getConnection()
            ...
            ->setComment('AHT Myoffice Employee Datetime Attribute Backend Table');
        $setup->getConnection()->createTable($table);
        $table = $setup->getConnection()
            ...
            ->setComment('AHT Myoffice Employee Decimal Attribute Backend Table');
        $setup->getConnection()->createTable($table);
        $table = $setup->getConnection()
            ...
            ->setComment('AHT Myoffice Employee Varchar Attribute Backend Table');
        $setup->getConnection()->createTable($table);
        $table = $setup->getConnection()
            ...
            ->setComment('AHT Myoffice Employee Text Attribute Backend Table');
        $setup->getConnection()->createTable($table);
